...
Производится за 32 счёта. Данный элемент - укороченная версия миксера дудлебской польки.
...
## 2. Lucky seven mixer (Лаки севен миксер)

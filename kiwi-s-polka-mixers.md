...
Все три польки-миксера объединяет наличие импровизационной части, которая позволяет разгуляться и не следить за тем, чтобы двигаться по кругу - т.к. для этого есть специальный сбор в круг на променадах. Так же все три польки содержат элемент приветствия нового партнёра.

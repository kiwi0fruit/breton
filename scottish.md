...
- __на 1-и-2-3-и-4__:  
  ...
  - _Дамы_: правой шаг вправо, левой приставить, правой шаг вправо (1-и-2), левой шаг влево, правой приставить, левой шаг влево (3-и-4),   - Ну и на каждый второй счёт можно немного поворачиваться (для настроения, или же, чтобы компенсировать предыдущие повороты).
- __на 1-2-3-4__: Бывает в нескольких вариациях, которые можно танцевать по выбору кавалера.  
  ...
  - ___Вращение с подскоками___. Всё тоже самое, что и при вращении, только шаги с подскоками: мгновенно после шага на ногу нужно подпрыгнуть на ней же (тогда если считать 1-и-2-и-3-и-4-и, то шаги будут на цифры, а подскоки - на "и" ).
  ...
  - ___Синхронный поворот___. Повернуться обоим одновременно за 4 счёта один или два раза как [здесь](https://www.youtube.com/watch?v=-ZF25wLaHS4),
  ...
  Ну и еще элементы:  
  - ___Around the World___. Обвод дамы вокруг кавалера (см. [видео](https://www.youtube.com/watch?v=FkLNLTTKd3k)),
  - ___Wheel___. Поворот открытой пары как целого вокруг оси пары (см. [видео](https://www.youtube.com/watch?v=DZXVDrn3CQM)),

### Замечания:
- Все движения кавалера и дамы должны быть синхронными, то есть соответствующие шаги они делают одновременно.
- Чтобы выполнить некоторые фигуры, нужно очень быстро дать понять партнёрше о том, что от неё требуется. Например, в синхронном повороте на счёт раз нужно и отправить даму во вращение и самому кавалеру начать вращаться. То есть времени поднять руку дамы и начать крутить нет. Можно только дать ей импульс левой рукой (которая сжимает правую руку дамы) в направлении куда ей нужно вращаться. А это можно сделать только если дама напрягат правую руку если её начинают вести (чтобы вестись сразу и всем туловищем) - для этого нужна привычка у дамы.
...
Еще можно посмотреть вот в этой хорошей [библиотеке видео](http://www.libraryofdance.org/dances/schottische/) с элементами. Там они хоть и даны большинство для какого-то бегающего скоттиша (в котором я особого смысла не вижу), но сам элемент выполняется на 4 счёта и поэтому может быть легко использован внутри стандартной схемы.

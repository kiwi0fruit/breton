...
1. **«Циркуль»** - компактное вращение **в паре**.
    ...
    - 1.3 **Двойное** вращение **№2**. Предположительно (требует проверки), быстрое **Двойное вращение №1** можно начать и с левой ноги кавалера, только поставить её не слева от дамы, а ей между ног.

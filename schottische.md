...
11. **Вход в верхнюю корзинку** - чтобы войти в верхнюю корзинку, нужно чтобы правая рука дамы была в правой руке кавалера. Тут можно было предварительно перехватить руки после поворота дамы или просто во время движения в бок и обратно, если начать его не в закрытой позиции, а держась за обе руки.
    * **Дама держит кавалера в верхней корзинке**. Левая рука к кавалера свободная, правой ведёт даму перед собой вправо, проводит у себя за спиной, кладет ее правую руку себе на шею, снизу хватает левой рукой левую руку дамы.
    * **Кавалер держит даму в верхней корзинке**. 
